...
public class FileSelectActivity extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        selectButton = (Button) findViewById(R.id.fileButtonSelect);
        ...
        selectButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedFile.exists() && selectedFile != null & selectedFile.isDirectory()) {
                    ...
                    getFragmentManager().beginTransaction().replace(R.id.content_frame,playFragment).commit();
      ...
      /*  if (selectionMode == SelectionMode.MODE_OPEN) {
        ...
        layoutSelect = (LinearLayout) findViewById(R.id.fileLinearLayoutSelect);
        //layoutCreate = (LinearLayout) findViewById(R.id.fLinearLayoutCreate);
        //layoutCreate.setVisibility(View.GONE);

        final Button cancelButton = (Button) findViewById(R.id.fileButtonCancel);
    ...
    private void getDirImpl(final String dirPath) {
        ...
        if (!currentPath.equals(ROOT)) {
            ...
            item.add(ROOT);
            addItem(ROOT, R.drawable.ic_folder_black_18dp);
            path.add(ROOT);

            item.add("../");
            addItem("../", R.drawable.ic_folder_black_18dp);
        ...
        SimpleAdapter fileList = new SimpleAdapter(this, mList, R.layout.file_item, new String[] {
                ITEM_KEY, ITEM_IMAGE }, new int[] { R.id.fdrowtext, R.id.fdrowimage });

        for (String dir : dirsMap.tailMap("").values()) {
            addItem(dir, R.drawable.ic_folder_black_18dp);
        }
